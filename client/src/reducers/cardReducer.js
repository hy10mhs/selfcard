import { CARD_LOADING, CARDS_LOADING, GET_CARD, SET_CARD, GET_CARDS, CLEAR_CARD, CLEAR_CARDS, INIT_PAGE, ADD_PAGE, DEL_PAGE, NEXT_PAGE, PREV_PAGE } from '../actions/types';
